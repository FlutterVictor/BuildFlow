...
// Módulo 09_AtrasosJustificativas: configuração visual isolada para edição futura.
export const screen: ModuleScreen = {
  highlights: [
    "Tratamento de desvios e justificativas",
  ...
  formFields: ["Motivo", "Criticidade", "Justificativa", "Evidência"]
};
