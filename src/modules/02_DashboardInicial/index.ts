...
// Módulo 02_DashboardInicial: configuração visual isolada para edição futura.
export const screen: ModuleScreen = {
  highlights: [
    "Resumo com KPIs e alertas recentes",
  ...
  formFields: ["Filtro de obra", "Filtro de período"]
};
