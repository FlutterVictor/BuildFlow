...
// Módulo 04_EstruturaObra: configuração visual isolada para edição futura.
export const screen: ModuleScreen = {
  highlights: [
    "Hierarquia da obra em blocos",
  ...
  formFields: ["Obra", "Área", "Subárea", "Disciplina", "Frente", "Pacote"]
};
