...
// Módulo 13_PlanejadoVsRealizado: configuração visual isolada para edição futura.
export const screen: ModuleScreen = {
  highlights: [
    "Comparativo detalhado de execução",
  ...
  formFields: ["Atividade", "Previsto", "Realizado", "Saldo"]
};
